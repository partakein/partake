...
public class EventTicketEditActionTest extends ActionControllerTest {
    ...
    public void testToShowWithLogin() throws Exception {
        ActionProxy proxy = getActionProxy(GET, "/events/edit/ticket/" + TestDataProvider.DEFAULT_EVENT_ID);
    ...
    public void testToShowInvalidEventId() throws Exception {
        ActionProxy proxy = getActionProxy(GET, "/events/edit/ticket/" + TestDataProvider.INVALID_EVENT_ID);
        loginAs(proxy, EVENT_OWNER_ID);
    ...
    public void testToShowWithNonUUID() throws Exception {
        ActionProxy proxy = getActionProxy(GET, "/events/edit/ticket/some-invalid-event-id");
        loginAs(proxy, EVENT_OWNER_ID);
